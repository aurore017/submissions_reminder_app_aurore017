...
Huguette, Shell Navigation, submitted
Lydivine, Shell Basics, not submitted
Phiona, Git, submitted
Hoziana, Git, submitted
Aurore, Shell Navigation, submitted
Nicia, shell Basics, not submitted
Orgad, Shell Navigation, submitted
Olive, Git, submitted
